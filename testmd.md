...
combines testnew (simple ---md header + html only code.
But instead of html straight md file exported from ipynb
...
for points $(x_1,y_1), (x_2,y_2)...(x_n,y_n)$  the least square regression line is:  nbb
$f(x)=\beta_0 + \beta_1x$    
$$f(x)=\beta_0 + \beta_1x$$    
